    ...
    <div className='min-h-screen px-5'>
        <div className='flex flex-col items-center justify-center h-[90vh]'>
            <Card className='box w-full lg:w-1/4 flex flex-col items-center rounded-md p-5'>
                ...
                <p className='py-3 text-center text-gray-400'>Cảm ơn đã tin tưởng và lựa chọn DTFood</p>
                <p className='py-2 text-center text-gray-200 text-lg'>Chúc bạn ngon miệng!</p>
                <Button onClick={()=>navigate("/")} variant='contained' className='py-5' sx={{marin:"1rem 0rem"}}>Trở về trang chủ</Button>
            </Card>
        </div>
    </div>
  )
